...
def get_auth_param():
	...
	if not GITHUBAPITOKEN or not GITHUB_USERNAME:
		logger.error("GITHUBAPITOKEN or GITHUB_USERNAME not set")
		exit(1)
	auth = HTTPBasicAuth(GITHUB_USERNAME, GITHUBAPITOKEN)
	return auth
...
if __name__ == '__main__':
	...
	starred_repos, stars_dict = get_git_stars(auth, use_cache, max_items)
